...
**libmultistreaming** is a library(Android module), forked from the well-established [libstreaming](https://github.com/fyhertz/libstreaming), offering new functionality and greater ease of use. It was developed in the course of a series of undergraduate Computing Degree final-year projects (FYP) supervised by Simon Pickin, a lecturer of the Computing Faculty (FDI) of the Complutense University of Madrid (UCM), the authors of the code being:
- Iván Gulyk (@ivangulyk) and Noel José Algora Igual (@NoelAlgora), FYP of 2019
- Daniel Alfaro Miranda and Luis Pozas Palomo (@luispozas), FYP of 2021
- Jingru Zhao (@zhaojr0514), FYP of 2023
- Miguel Verdaguer (@verdx), FYP of 2024
The authors of an FYP of 2020, Francisco Calero Velasco (@FCalero), Sergio Manzanaro Caraballo (@SergioManzanaro) and David Salido Camacho (@davidsalido), contributed to the understanding of the use of the library but not to its code.
...
It is recommended to add it as a submodule inside your repository. This way if anyone clones your repository it will be easily downloaded. To do so run the following:
