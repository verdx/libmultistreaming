...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(net.verdx.libstreaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(net.verdx.libstreaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link net.verdx.libstreaming.rtp.RtpSocket}.
