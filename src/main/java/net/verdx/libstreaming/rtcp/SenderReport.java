...
package net.verdx.libstreaming.rtcp;
...
import static net.verdx.libstreaming.rtp.RtpSocket.TRANSPORT_TCP;
import static net.verdx.libstreaming.rtp.RtpSocket.TRANSPORT_UDP;
